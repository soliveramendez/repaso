...
input.setAttribute("placeholder","lista nueva")//palceholder es el espacio que tengo para escribir
//nodos
btn.appendChild(nodoText);//estoy guardando el texto enel boton
